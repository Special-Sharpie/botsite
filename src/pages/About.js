            ...
            <div className="container-md">
                <div className="row justify-content-center upperpadding">
                    <div className="col-sm-4 row justify-content-center">
                        <img className="botimage" src="../media/Hockey_Bot_Logo_lower.jpg" alt=''/>
                    </div>
                    <div className="col-sm-8 upperpadding" >
                        <h1>
                            HockeyStats Bot
                        </h1>
                        <p style= {{marginBottom: 0}}>A Discord bot dedicated to providing live-updating, accurate hockey stats in your Discord server! </p>
                    </div>
                </div>
                <div className="jumbotron hsbheadline">
                    <p>
                        ...
                        <br/>
                        <br/>
                        Now with support for Discord Slash commands, its easier then ever to make requests!
                        Whether its for Fantasy, Trivia, or just trying to prove a friend wrong, HockeyStats Bot will fit perfectly in your hockey server or community!
                        <br/>
                        <br/>
                ...
                <div className="row justify-content-evenly text-center uppermargin" >
                    ...
                    <div className="col-lg-6 justify-content-center alternatingimage">
                        <img className="hsbimage" alt='' src="media/daySum.png"/>
                    </div>
                </div>
                <div className="row justify-content-evenly text-center uppermargin" >
                    <div className="col-lg-6 justify-content-center alternatingimage">
                        <img className="hsbimage" alt='' src="media/pinfo.png"/>
                    </div>
                    <div className="col-lg-6 justify-content-center alternatingtext">
                        <h2 className='hsbimagetext'>Trivia, and random facts about teams, players, drafts and so much more!</h2>
                    </div>
                </div>
                <div className="row justify-content-evenly text-center uppermargin" >
                    <div className="col-lg-6 justify-content-center alternatingtext">
                        <h2 className='hsbimagetext'>Keep tabs on the performance of you favourite players!</h2>
                    </div>
                    <div className="col-lg-6 justify-content-center alternatingimage">
                ...
                <div className="jumbotron hsbheadline">
                    <p>
                        ...
                        <br/>
                        So <a href="/invite">add the bot</a>, and join the community!
                    </p>
                </div>
            </div>
            <footer>
